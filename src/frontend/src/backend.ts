...
export class Backend implements backendInterface {
    ...
    async adminRecordMatch(arg0: Principal, arg1: Principal, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminRecordMatch(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminResetStats(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminResetStats(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminSetStats(arg0: Principal, arg1: UserStats): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminSetStats(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordDraw(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordDraw(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordMatch(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordMatch(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
